<?php
namespace ShopMobi\ApiOptimizer;
...
class Plugin {
    ...
    private function load() {
        require_once SHOPMOBI_AO_PATH . 'includes/endpoints/class-auth-endpoints.php';
        require_once SHOPMOBI_AO_PATH . 'includes/endpoints/class-password-reset-endpoints.php';
        require_once SHOPMOBI_AO_PATH . 'includes/endpoints/class-general-settings-endpoint.php';
        require_once SHOPMOBI_AO_PATH . 'includes/endpoints/class-stripe-payment-endpoint.php';
        require_once SHOPMOBI_AO_PATH . 'includes/endpoints/class-payment-gateways-endpoint.php';
        require_once SHOPMOBI_AO_PATH . 'includes/filters/class-field-optimizer.php';
        require_once SHOPMOBI_AO_PATH . 'includes/filters/class-product-response-filter.php';
        require_once SHOPMOBI_AO_PATH . 'includes/admin/class-settings-page.php';
    }
    ...
    public function missing_wc_notice() {
        printf(
            '<div class="error"><p><strong>ShopMobi – API Optimizer for WooCommerce</strong> requires WooCommerce to be installed and active.</p></div>'
        );
    }
}
